...
const pageSchema = {
  ...
  name: "마이리얼트립 쿠폰",
  url: SITE,
  description: "2026년 9월 마이리얼트립 쿠폰을 한눈에 확인하세요. 현재 사용 가능한 마이리얼트립 할인쿠폰부터 쿠폰 받는 법까지 다양한 정보도 함께 정리되어 있습니다.",
  potentialAction: {
    "@type": "SearchAction",
...
const LINKPRICE_URL = "https://myrealt.rip/ai1986";
...
const coupons = [
  ...
  { code: "LINKPRICE1000", discount: "1,000원", minPurchase: "50,000원", category: "해외 투어·티켓", validity: "발급일로부터 7일", image: coupon1, link: LINKPRICE_URL },
  { code: "LINKPRICE3000", discount: "3,000원", minPurchase: "150,000원", category: "해외 투어·티켓", validity: "발급일로부터 7일", image: coupon2, link: LINKPRICE_URL },
];
...
const Index = () => (
  <>
    <Head>
      ...
      <meta name="description" content="2026년 9월 마이리얼트립 쿠폰을 한눈에 확인하세요. 현재 사용 가능한 마이리얼트립 할인쿠폰부터 쿠폰 받는 법까지 다양한 정보도 함께 정리되어 있습니다." />
      <link rel="canonical" href={SITE} />
      <meta property="og:title" content="마이리얼트립 쿠폰" />
      <meta property="og:description" content="2026년 9월 마이리얼트립 쿠폰을 한눈에 확인하세요. 현재 사용 가능한 마이리얼트립 할인쿠폰부터 쿠폰 받는 법까지 다양한 정보도 함께 정리되어 있습니다." />
    ...
    <section className="relative overflow-hidden" aria-label="히어로 배너">
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-20 sm:py-28 md:py-36 text-center">
        <span className="badge-primary mb-4 inline-block">2026년 9월 최신</span>
      ...
      <div className="space-y-6">
        {coupons.map((c, i) => (
          <div key={i} className="card-elevated p-6">
            ...
            <CouponCopyButton code={c.code} label="할인코드 복사" href={c.link} />
