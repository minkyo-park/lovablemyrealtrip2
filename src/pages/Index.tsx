...
const pageSchema = {
  ...
  name: "마이리얼트립 쿠폰",
  url: SITE,
  description: "2026년 8월 마이리얼트립 쿠폰을 한눈에 확인하세요. 현재 사용 가능한 마이리얼트립 할인쿠폰부터 쿠폰 받는 법까지 다양한 정보도 함께 정리되어 있습니다.",
  potentialAction: {
    "@type": "SearchAction",
...
const Index = () => (
  <>
    <Head>
      ...
      <meta name="description" content="2026년 8월 마이리얼트립 쿠폰을 한눈에 확인하세요. 현재 사용 가능한 마이리얼트립 할인쿠폰부터 쿠폰 받는 법까지 다양한 정보도 함께 정리되어 있습니다." />
      <link rel="canonical" href={SITE} />
      <meta property="og:title" content="마이리얼트립 쿠폰" />
      <meta property="og:description" content="2026년 8월 마이리얼트립 쿠폰을 한눈에 확인하세요. 현재 사용 가능한 마이리얼트립 할인쿠폰부터 쿠폰 받는 법까지 다양한 정보도 함께 정리되어 있습니다." />
    ...
    <section className="relative overflow-hidden" aria-label="히어로 배너">
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-20 sm:py-28 md:py-36 text-center">
        <span className="badge-primary mb-4 inline-block">2026년 8월 최신</span>
